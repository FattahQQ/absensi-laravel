...
<div class="container py-4">
    ...
    <div class="hero-header mb-4 d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="mb-0 opacity-75">Presensi Kehadiran Jarak Jauh (WFH) Praktis & Aman</p>
        </div>
        <div class="text-end d-none d-md-block">
            <h5 class="fw-bold mb-0" id="clock">00:00:00</h5>
            <small id="date" class="opacity-75"></small>
        </div>
    </div>
    ...
    <div class="card card-custom">
        <div class="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
            <h5 class="fw-bold mb-0 text-dark"><i class="bi bi-clock-history me-2 text-primary"></i>Riwayat Presensi</h5>
