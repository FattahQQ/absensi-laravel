            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1">
                        ...
                        <li class="breadcrumb-item active text-primary fw-semibold" aria-current="page">RealTime Today Record</li>
                    </ol>
                </nav>
                <h3 class="fw-bold text-dark mb-0"><i class="bi bi-clock-history text-primary me-2"></i> Laporan Rekaman Kehadiran Hari Ini (RealTime)</h3>
            </div>
