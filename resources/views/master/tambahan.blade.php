...
<head>
    ...
    <title>Master Tambahan - Enterprise Workforce</title>
    ...
    <div class="container py-5">
        ...
        <div class="card card-saas mb-4">
            <div class="card-header-saas d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-warning-custom text-white"><i class="bi bi-plus-lg me-1"></i> Tambah Atribut</button>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0 text-center table-saas">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-start fw-semibold text-dark">Lokasi Radius GPS Kantor Utama</td>
                                <td class="font-mono text-secondary">Geofence (Meter)</td>
                                <td>Radius maksimal 100 meter</td>
