        ...
        <div class="card card-saas mb-4">
            <div class="card-header-saas d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-2">
                    <div class="bg-primary bg-opacity-10 text-primary p-2 rounded-2"><i class="bi bi-people"></i></div>
                    <span class="fw-bold">Database Induk Pegawai & Organisasi</span>
                </div>
                <button type="button" class="btn btn-primary-custom"><i class="bi bi-person-plus me-1"></i> Tambah Data Utama</button>
            </div>
