...
<head>
    ...
    <style>
        ...
        .btn-custom { background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%); color: #fff; border: none; border-radius: 10px; font-weight: 600; padding: 10px 18px; font-size: 0.875rem; box-shadow: 0 4px 12px rgba(124, 58, 237, 0.25); }
    </style>
</head>
<body>
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1">
                        ...
                        <li class="breadcrumb-item active fw-semibold" style="color: #7c3aed;" aria-current="page">Ijin Lembur OverTime</li>
                    </ol>
                </nav>
                <h3 class="fw-bold text-dark mb-0"><i class="bi bi-stopwatch me-2" style="color: #7c3aed;"></i> Transaksi Pengajuan Lembur (OverTime)</h3>
            </div>
