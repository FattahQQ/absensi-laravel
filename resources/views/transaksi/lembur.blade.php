...
<head>
    ...
    <title>Ijin Lembur OverTime - Enterprise Workforce</title>
    ...
    <style>
        ...
        body { background: linear-gradient(180deg, #f5f7fb 0%, #f7f3ff 100%); font-family: 'Inter', sans-serif; color: var(--text); }
        .page-wrapper { max-width: 1320px; margin: 0 auto; padding: 38px 12px 48px; }
        .top-hero {
            background: linear-gradient(135deg, rgba(15,23,42,0.96) 0%, rgba(124,58,237,0.94) 48%, rgba(109,40,217,0.85) 100%);
            border: 1px solid rgba(148,163,184,0.2); border-radius: 26px; box-shadow: 0 20px 40px rgba(124,58,237,0.18); color: #fff; padding: 24px 28px; margin-bottom: 24px;
        }
        ...
        .btn-custom { background: linear-gradient(135deg, var(--accent) 0%, var(--accent-dark) 100%); color: #fff; border: none; border-radius: 12px; font-weight: 700; padding: 10px 18px; font-size: 0.875rem; box-shadow: 0 8px 18px rgba(124,58,237,0.18); }
    </style>
</head>
<body>
            ...
            <div>
                <nav aria-label="breadcrumb" class="crumbs">
                    <ol class="breadcrumb mb-2" style="background: transparent; margin: 0; padding: 0;">
                        ...
                        <li class="breadcrumb-item active text-white-50" aria-current="page">Ijin Lembur OverTime</li>
                    </ol>
                </nav>
                <div class="header-badge"><i class="bi bi-stopwatch"></i> Overtime Request</div>
                <h3 class="page-title"><i class="bi bi-stopwatch me-2"></i> Transaksi Pengajuan Lembur (OverTime)</h3>
            </div>
        ...
        <div class="card card-saas mb-4">
            <div class="card-header-saas d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="d-flex align-items-center gap-2">
                    <div class="p-2 rounded-2" style="background-color: rgba(124, 58, 237, 0.1); color: #7c3aed;"><i class="bi bi-clock"></i></div>
                    <span class="fw-bold">Daftar Pengajuan OverTime Pegawai</span>
                </div>
                <button type="button" class="btn btn-custom"><i class="bi bi-plus-lg me-1"></i> Ajukan Lembur</button>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0 text-center table-saas">
                        <thead>
                            <tr>
                                ...
                                <th class="py-3">Durasi Waktu</th>
                                <th class="py-3 text-start">Tugas / Output Pekerjaan</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-start fw-semibold text-dark">Superadmin LSP</td>
                                <td class="font-mono small">03 Sep 2026</td>
                                <td class="font-mono text-dark fw-bold">18:00 - 21:00 (3 Jam)</td>
                                <td class="text-start text-secondary small">Deployment patch sistem keamanan server Laravel.</td>
