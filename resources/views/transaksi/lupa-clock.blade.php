...
<head>
    ...
    <title>Ijin Lupa Clock In/Out - Enterprise Workforce</title>
    ...
    <style>
        ...
        body { background: linear-gradient(180deg, #f5f7fb 0%, #edf8ff 100%); font-family: 'Inter', sans-serif; color: var(--text); }
        .page-wrapper { max-width: 1320px; margin: 0 auto; padding: 38px 12px 48px; }
        .top-hero {
            background: linear-gradient(135deg, rgba(15,23,42,0.96) 0%, rgba(14,165,233,0.93) 48%, rgba(3,105,161,0.85) 100%);
            border: 1px solid rgba(148,163,184,0.2); border-radius: 26px; box-shadow: 0 20px 40px rgba(14,165,233,0.18); color: #fff; padding: 24px 28px; margin-bottom: 24px;
        }
        ...
        .btn-custom { background: linear-gradient(135deg, var(--accent) 0%, var(--accent-dark) 100%); color: #fff; border: none; border-radius: 12px; font-weight: 700; padding: 10px 18px; font-size: 0.875rem; box-shadow: 0 8px 18px rgba(14,165,233,0.18); }
    </style>
</head>
<body>
            ...
            <div>
                <nav aria-label="breadcrumb" class="crumbs">
                    <ol class="breadcrumb mb-2" style="background: transparent; margin: 0; padding: 0;">
                        ...
                        <li class="breadcrumb-item active text-white-50" aria-current="page">Ijin Lupa Clock In/Out</li>
                    </ol>
                </nav>
                <div class="header-badge"><i class="bi bi-fingerprint"></i> Attendance Correction</div>
                <h3 class="page-title"><i class="bi bi-fingerprint me-2"></i> Transaksi Ijin Koreksi Lupa Absen</h3>
            </div>
        ...
        <div class="card card-saas mb-4">
            <div class="card-header-saas d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="d-flex align-items-center gap-2">
                    <div class="bg-info bg-opacity-10 text-info p-2 rounded-2"><i class="bi bi-file-earmark-text"></i></div>
                    <span class="fw-bold">Riwayat Pengajuan Lupa Absen Masuk / Keluar</span>
                </div>
                <button type="button" class="btn btn-custom text-white"><i class="bi bi-plus-lg me-1"></i> Ajukan Koreksi</button>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0 text-center table-saas">
                        <thead>
                            <tr>
                                ...
                                <th class="py-3">Tipe Koreksi</th>
                                <th class="py-3">Tanggal Kejadian</th>
                                <th class="py-3">Jam Pengganti</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-start fw-semibold text-dark">Muhammad Tegar</td>
                                <td><span class="badge bg-info bg-opacity-10 text-info border border-info border-opacity-25 px-3 py-1 rounded-pill font-mono">Lupa Clock Out</span></td>
                                <td class="font-mono small">03 Sep 2026</td>
                                <td class="font-mono text-dark fw-bold">17:00 WIB</td>
                                <td><span class="badge bg-warning bg-opacity-10 text-warning border border-warning border-opacity-25 px-3 py-1 rounded-pill">Menunggu Verifikasi</span></td>
                                <td>
